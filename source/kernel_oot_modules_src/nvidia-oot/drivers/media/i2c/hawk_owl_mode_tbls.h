...
static struct index_reg_8 i2c_address_trans_hawk_Single_ser[] = {
	{0x52, 0x0006, 0x11},
	{0x80, 0x0000, 0x94},
	{0x00, AR0234_TABLE_END, 0x00}
};

static struct index_reg_8 i2c_address_trans_hawk_Dual_ser[] = {
	{0x52, 0x0006, 0x11},
	{0x80, 0x0000, 0x94},
	{0x52, 0x0006, 0x33},
	{0x80, 0x0000, 0x96},
...
static struct index_reg_8 i2c_address_trans_hawk_Triple_ser[] = {
	{0x52, 0x0006, 0x11},
	{0x80, 0x0000, 0x94},
	{0x52, 0x0006, 0x33},
	{0x80, 0x0000, 0x96},
...
static struct index_reg_8 i2c_address_trans_hawk_Quad_ser[] = {
	{0x52, 0x0006, 0x11},
	{0x80, 0x0000, 0x94},
	{0x52, 0x0006, 0x33},
	{0x80, 0x0000, 0x96},
...
static struct index_reg_8 i2c_address_trans_owl_Dual_ser[] = {
	{0x52, 0x0006, 0x11},
	{0x80, 0x0000, 0x94},
	{0x52, 0x0006, 0x33},
	{0x80, 0x0000, 0x96},
...
static struct index_reg_8 i2c_address_trans_owl_Triple_ser[] = {
	{0x52, 0x0006, 0x11},
	{0x80, 0x0000, 0x94},
	{0x52, 0x0006, 0x33},
	{0x80, 0x0000, 0x96},
...
static struct index_reg_8 i2c_address_trans_owl_Quad_ser[] = {
	{0x52, 0x0006, 0x11},
	{0x80, 0x0000, 0x94},
	{0x52, 0x0006, 0x33},
	{0x80, 0x0000, 0x96},
...
static struct index_reg_8 ar0234_Hawk_SingleLink_Dser_Ser[] = {
	...
	/* Set Video pipe to MIPI controller */
	/* For HAWK1 */
...
static struct index_reg_8 ar0234_Hawk_DualLink_Dser_Ser[] = {
	{0x52, 0x1458, 0x28},
	{0x52, 0x1459, 0x68},
	{0x52, 0x1558, 0x28},
	{0x52, 0x1559, 0x68},
	...
	{0x52, 0x00F4, 0xff}, // Enable pipe 0
...
static struct index_reg_8 ar0234_Hawk_TripleLink_Dser_Ser[] = {
	{0x52, 0x1458, 0x28},
	{0x52, 0x1459, 0x68},
	{0x52, 0x1558, 0x28},
	{0x52, 0x1559, 0x68},
	...
	{0x98, 0x0002, 0x33}, // Enable pipes X and Y
	{0x98, 0x0308, 0x7E}, // Pipe X pulls clock from port A, pipe Y from port B
	...
	/* For HAWK3 */
	{0x52, 0x0A0B, 0x07}, // Enable 3 mappings Pipe 4 i.e RAW10, FS & FE mappings.
	{0x52, 0x0A2D, 0x2A}, // Map all 3 mappings to controller 2
	{0x52, 0x0A0D, 0x2B}, // Input RAW10 on VC0
	{0x52, 0x0A0E, 0x2B}, // Output RAW10 on VC0
	{0x52, 0x0A0F, 0x00}, // Input FS on VC0
	{0x52, 0x0A10, 0x00}, // Output FS on VC0
	{0x52, 0x0A11, 0x01}, // Input FE on VC0
	{0x52, 0x0A12, 0x01}, // Output FE on VC0

	{0x52, 0x0A4B, 0x07}, // Enable 3 mappings Pipe 5 i.e RAW10, FS & FE mappings.
	{0x52, 0x0A6D, 0x2A}, // Map all 3 mappings to controller 2
	{0x52, 0x0A4D, 0x2B}, // Input RAW10 on VC0
	{0x52, 0x0A4E, 0x6B}, // Output RAW10 on VC1
	{0x52, 0x0A4F, 0x00}, // Input FS on VC0
	{0x52, 0x0A50, 0x40}, // Output FS on VC1
	{0x52, 0x0A51, 0x01}, // Input FE on VC0
...
static struct index_reg_8 ar0234_Hawk_QuadLink_Dser_Ser[] = {
	{0x52, 0x1458, 0x28},
	{0x52, 0x1459, 0x68},
	{0x52, 0x1558, 0x28},
	{0x52, 0x1559, 0x68},
	...
	{0x9a, 0x0002, 0x33}, // Enable pipes X and Y
	{0x9a, 0x0308, 0x7E}, // Pipe X pulls clock from port A, pipe Y from port B
	{0x9a, 0x0311, 0x21}, // Pipe X pulls data from port A, pipe Y from port B
	{0x9a, 0x0316, 0x6b}, // RAW10 to pipe Y
	{0x9a, 0x0314, 0x6b}, // RAW10 to pipe Y
	{0x52, 0x00F4, 0xff}, // Enable pipe 0
	...
	/* For HAWK4 */
	{0x52, 0x0A8B, 0x07}, // Enable 3 mappings Pipe 6 i.e RAW10, FS & FE mappings.
	{0x52, 0x0AAD, 0x3F}, // Map all 3 mappings to controller 3
	{0x52, 0x0A8D, 0x2B}, // Input RAW10 on VC0
	{0x52, 0x0A8E, 0x2B}, // Output RAW10 on VC0
	{0x52, 0x0A8F, 0x00}, // Input FS on VC0
	{0x52, 0x0A90, 0x00}, // Output FS on VC0
	{0x52, 0x0A91, 0x01}, // Input FE on VC0
	{0x52, 0x0A92, 0x01}, // Output FE on VC0

	{0x52, 0x0ACB, 0x07}, // Enable 3 mappings Pipe 7 i.e RAW10, FS & FE mappings.
	{0x52, 0x0AED, 0x3F}, // Map all 3 mappings to controller 3
	{0x52, 0x0ACD, 0x2B}, // Input RAW10 on VC0
	{0x52, 0x0ACE, 0x6B}, // Output RAW10 on VC1
	{0x52, 0x0ACF, 0x00}, // Input FS on VC0
	{0x52, 0x0AD0, 0x40}, // Output FS on VC1
	{0x52, 0x0AD1, 0x01}, // Input FE on VC0
...
static struct index_reg_8 ar0234_Owl_QuadLink_Dser_Ser[] = {
	{0x52, 0x1458, 0x28},
	{0x52, 0x1459, 0x68},
	{0x52, 0x1558, 0x28},
	{0x52, 0x1559, 0x68},
...
static struct index_reg_8 Owl_QuadLink_Dser_InFsync[] = {
	...
	{0x9A, 0x02C7, 0x04}, //MFP3 for FSIN
	{0x9A, 0x02C9, 0x08},
...
enum {
	...
	AR0234_MODE_HAWK_SINGLELINK_DSER_SER,
	AR0234_MODE_OWL_SINGLELINK_DSER_SER,
	AR0234_MODE_HAWK_DUALLINK_DSER_SER,
	AR0234_MODE_OWL_DUALLINK_DSER_SER,
	AR0234_MODE_HAWK_TRIPLELINK_DSER_SER,
	AR0234_MODE_OWL_TRIPLELINK_DSER_SER,
	AR0234_MODE_HAWK_QUADLINK_DSER_SER,
	AR0234_MODE_OWL_QUADLINK_DSER_SER,
...
static struct index_reg_8 *mode_table[] = {
	...
	[AR0234_MODE_STOP_STREAM]
		= ar0234_stop,
	[AR0234_MODE_HAWK_SINGLELINK_DSER_SER] = ar0234_Hawk_SingleLink_Dser_Ser,
	[AR0234_MODE_OWL_SINGLELINK_DSER_SER] = ar0234_Owl_SingleLink_Dser_Ser,
	[AR0234_MODE_HAWK_DUALLINK_DSER_SER] = ar0234_Hawk_DualLink_Dser_Ser,
	[AR0234_MODE_OWL_DUALLINK_DSER_SER] = ar0234_Owl_DualLink_Dser_Ser,
	[AR0234_MODE_HAWK_TRIPLELINK_DSER_SER] = ar0234_Hawk_TripleLink_Dser_Ser,
	[AR0234_MODE_OWL_TRIPLELINK_DSER_SER] = ar0234_Owl_TripleLink_Dser_Ser,
	[AR0234_MODE_HAWK_QUADLINK_DSER_SER] = ar0234_Hawk_QuadLink_Dser_Ser,
	[AR0234_MODE_OWL_QUADLINK_DSER_SER] = ar0234_Owl_QuadLink_Dser_Ser,
